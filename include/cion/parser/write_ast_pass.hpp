...
namespace cion {
	class WriteASTPass final : public RecursiveTraverser {
	public:
...
//////////////////////////////////////////////////////////////////////////////////////////
/////// Members & Helper Functions/Structs
//////////////////////////////////////////////////////////////////////////////////////////

		struct Block final {
		public:
			explicit Block(WriteASTPass & p_writer);
			~Block() noexcept;

		private:
			WriteASTPass & m_writer;
		};

		Block create_block();
		std::string depth_str();
		Block writeln(std::string const&);
		void inc_depth();
		void dec_depth();
