...
namespace cion {
	...
	CionTokenTypes::CionTokenTypes():
		...
		type_int    {init_tt({"primitive type: int"  , "int"})},
		type_int8   {init_tt({"primitive type: int8" , "int8"})},
		type_int16  {init_tt({"primitive type: int16", "int16"})},
		type_int32  {init_tt({"primitive type: int32", "int32"})},
		type_int64  {init_tt({"primitive type: int64", "int64"})},

		type_uint   {init_tt({"primitive type: uint"  , "uint"})},
		type_uint8  {init_tt({"primitive type: uint8" , "uint8"})},
		type_uint16 {init_tt({"primitive type: uint16", "uint16"})},
		type_uint32 {init_tt({"primitive type: uint32", "uint32"})},
		type_uint64 {init_tt({"primitive type: uint64", "uint64"})},

		type_float  {init_tt({"primitive type: float"  , "float"})},
		type_float16{init_tt({"primitive type: float16", "float16"})},
		type_float32{init_tt({"primitive type: float32", "float32"})},
		type_float64{init_tt({"primitive type: float64", "float64"})},
		...
		op_ampersand {init_tt({"operator: ampersand (&)", "&"})},
